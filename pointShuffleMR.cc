...
//#define INPUT_NAME "kmeans_14b.input"
//#define INPUT_NAME "k28b.input"
//#define INPUT_NAME "k2G.input"
//#define INPUT_NAME "k112b.input"
#define INPUT_NAME "k1G.input"
#define ITERATIONS 5 
...
//{"peach", "my", "name", "dfs", "soo", "jeong", "you", "dog", "hi", "hello"};
...
//---calculate new centroids-----------
  ...
  for(unordered_multimap<std::string, void*>::iterator it = prePoints->begin(); it != prePoints->end(); ++it){
    string key = it->first;
    Point p(key);
